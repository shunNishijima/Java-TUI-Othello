...
/**
 * Make exact changes to the board. Define game logic like win. Using move setting marks on the board.
 * It is related to the Board, and Move, Player. When it is initialized,
 * get parameters to set the player and make a new board. And move is used as a parameter for making changes.
 */
...
public class OthelloGame implements Game{
    ...
    */
    ...
    /**
     * This implementation is using for AI logic
     * @return put valid moves to Array Move.
     */
    public Move[] getValidMovesArray() {
        Move[] moves = new Move[getValidMoves().size()];
        if(getTurn()==player1){
            int j = 0;
            for(int i=0;i<Board.DIM*Board.DIM;i++){
                OthelloMove othelloMove = new OthelloMove(Mark.BLACK,i);
    ...
    public boolean isValidMove(Move move) {
        ...
        if(!(((OthelloMove) move).getLocation()<9)){
            ...
            if(board.getField(((OthelloMove) move).getLocation()-8)==mark.other()){
                //Check there is its mark after sequence of other mark above.
    ...
    */
     ...
     */
    public OthelloGame gameDeepCopy(){
        OthelloGame oGame = new OthelloGame(this.player1, this.player2);
        oGame.setBoard(this.board.deepCopy());
        return oGame;
    }

    /**
     * setter for player1
     * @param player1 new defined player
     */
    ...
    /**
     * setter for player2
     * @param player2 new defined player
     */
