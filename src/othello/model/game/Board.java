...
/**
 * checking the status of the board. initialized when the game has started.
 * defining what the board is. It is related to the OthelloGame.
 * When the OthelloGame is constructed, the Board also is made and used by the OthelloGame.
 */
public class Board {
    /**
    ...
    public Board deepCopy() {
        ...
        System.arraycopy(this.fields, 0, deepCopy.fields, 0, DIM * DIM);
         return deepCopy;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < DIM; i++) {
            ...
            if (i < DIM - 1) {
                s.append("\n").append(LINE).append(DELIM).append(NUMBERING[i * 2 + 1]).append("\n");
            }
        }
        return s.toString();
    }
